...
#ifndef AI_AUDIO_MODEL_H
#define AI_AUDIO_MODEL_H
#pragma once

#include "audio_model_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_AUDIO_MODEL_MODEL_NAME          "audio_model"
#define AI_AUDIO_MODEL_ORIGIN_MODEL_NAME   "audio_model"

/******************************************************************************/
#define AI_AUDIO_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_AUDIO_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_AUDIO_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_AUDIO_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_AUDIO_MODEL_IN \
  ai_audio_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_AUDIO_MODEL_IN_SIZE { \
  AI_AUDIO_MODEL_IN_1_SIZE, \
}
#define AI_AUDIO_MODEL_IN_SIZE_BYTES { \
  AI_AUDIO_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_AUDIO_MODEL_IN_1_FORMAT      AI_BUFFER_FORMAT_S8
#define AI_AUDIO_MODEL_IN_1_HEIGHT      (64)
#define AI_AUDIO_MODEL_IN_1_WIDTH       (96)
#define AI_AUDIO_MODEL_IN_1_CHANNEL     (1)
#define AI_AUDIO_MODEL_IN_1_SIZE        (64 * 96 * 1)
#define AI_AUDIO_MODEL_IN_1_SIZE_BYTES  (6144)

/******************************************************************************/
#define AI_AUDIO_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_AUDIO_MODEL_OUT \
  ai_audio_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_AUDIO_MODEL_OUT_SIZE { \
  AI_AUDIO_MODEL_OUT_1_SIZE, \
}
#define AI_AUDIO_MODEL_OUT_SIZE_BYTES { \
  AI_AUDIO_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_AUDIO_MODEL_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_AUDIO_MODEL_OUT_1_CHANNEL     (10)
#define AI_AUDIO_MODEL_OUT_1_SIZE        (10)
#define AI_AUDIO_MODEL_OUT_1_SIZE_BYTES  (40)

/******************************************************************************/
#define AI_AUDIO_MODEL_N_NODES (9)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup audio_model
 ...
 * @ref ai_audio_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_audio_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_audio_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_audio_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_AUDIO_MODEL_*
 * defines into file @ref audio_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_audio_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_AUDIO_MODEL_H */
