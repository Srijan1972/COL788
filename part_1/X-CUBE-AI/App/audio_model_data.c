...
ai_buffer g_audio_model_data_map_activations[AI_AUDIO_MODEL_DATA_ACTIVATIONS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 37184, 1, 1),
    37184, NULL, NULL),    /* heap_overlay_pool */
  };
ai_buffer g_audio_model_data_map_weights[AI_AUDIO_MODEL_DATA_WEIGHTS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 24312, 1, 1),
    24312, NULL, s_audio_model_weights_array_u64),   /* weights_array */
  };
