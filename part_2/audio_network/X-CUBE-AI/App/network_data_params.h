...
#define AI_NETWORK_DATA_ACTIVATIONS_SIZES \
  { 37184, }
#define AI_NETWORK_DATA_ACTIVATIONS_SIZE     (37184)
#define AI_NETWORK_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_DATA_ACTIVATION_1_SIZE    (37184)



#define AI_NETWORK_DATA_WEIGHTS_SIZES \
  { 24312, }
#define AI_NETWORK_DATA_WEIGHTS_SIZE         (24312)
#define AI_NETWORK_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_DATA_WEIGHT_1_SIZE        (24312)
